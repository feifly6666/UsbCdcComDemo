...
public class MainActivity extends AppCompatActivity {
    ...
    private static String Tag = "UsbCdcCom";
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                if (!editText.getText().toString().equals("")) {
                    ...
                    if (usbService != null) {
                        if(chbHexIn.isChecked()){
                            usbService.write(HexUtil.decodeHex(data));
                        } else {
        ...
        chbHexIn.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener(){
            ...
            public void onCheckedChanged(CompoundButton buttonView,
                                         boolean isChecked) {
                if(isChecked){
                    Log.d(Tag,"hex in checked");
                }else{
                    Log.d(Tag,"hex in unchecked");
                }
            }
        });
        ...
        chbHexout.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener(){
            ...
            public void onCheckedChanged(CompoundButton buttonView,
                                         boolean isChecked) {
                if(isChecked){
                    Log.d(Tag,"hex out checked");
                }else{
                    Log.d(Tag,"hex out unchecked");
                }
            }
        });
    }
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case UsbService.MESSAGE_FROM_SERIAL_PORT:
                    ...
                    if(chbHexout.isChecked()){
                        mActivity.get().display.append(HexUtil.encodeHexStr(data.getBytes()));
                    } else {
